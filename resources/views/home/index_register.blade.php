...
<main role="main" class="h-100">
           ...
           <div class="row">
            ...
            <div class="card my-3">
            <div class="card-body">
            <h5 class="text-dark text-uppercase mb-4">Register</h5>
            <form class="new_user" id="new_user" action="smm.html" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="xFSD2qel3xV9h+0RW8H7QSfY33lp2BBNPq0Msay81rhFqzY6Lz32PIBqRnIXebS/SlF7LWSZIKGsUXAHYqYZpg==" autocomplete="off" />
            ...
            <div class="mb-3"><label class="form-label required" for="user_password">Password</label><input autocomplete="new-password" class="form-control form-control bg-light text-white" type="password" name="user[password]" id="user_password" /></div>
            <div class="mb-3"><label class="form-label" for="user_password_confirmation">Password confirmation</label><input autocomplete="new-password" class="form-control form-control bg-light text-white" type="password" name="user[password_confirmation]" id="user_password_confirmation" /></div>
            <br>

...
<body>
  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-dark">
        ...
        <a href="/register" class="btn btn-light mr-2 btn-sm text-muted">
        Register
        </a>
    ...
    <main role="main" class="h-100">
           ...
           <div class="row">
            ...
            <form class="new_user" id="new_user" action="{{ route('register') }}" accept-charset="UTF-8" method="post">
                ...
                @csrf
                <div class="mb-3">
                    <label class="form-label required" for="user_email">name</label>
                    <input autofocus="autofocus" autocomplete="email" class="form-control form-control bg-light text-white" type="text" value name="name" id="name" />
                </div>
                @if ($errors->has('name'))
                ...
                <div class="mb-3">
                    ...
                    <input autofocus="autofocus" autocomplete="email" class="form-control form-control bg-light text-white" type="email" value name="email" id="email" />
                </div>
                @if ($errors->has('email'))
                                    <span class="help-block">
                ...
                <div class="mb-3">
                    ...
                    <input autocomplete="new-password" class="form-control form-control bg-light text-white" type="password" name="password" id="password" />
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input autocomplete="new-password" class="form-control form-control bg-light text-white" type="password" name="password_confirmation" id="password_confirmation" /></div>
                <br>

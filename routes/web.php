...
Route::get('/platform', [HomeController::class, 'platforms'])->name('platforms');
Route::get('/search', [HomeController::class, 'search'])->name('search');

Route::group(['middleware' => ['auth']], function() {
    Route::get('/deposit', [DepositController::class, 'index'])->name('deposite_index');
    Route::post('/deposit', [DepositController::class, 'store'])->name('deposite');
    Route::get('/dashboard', [HomeController::class, 'dashboard'])->name('dashboard');
    Route::get('/userpanels', [HomeController::class, 'userpanels'])->name('userpanels');
    Route::get('/contact', [HomeController::class, 'contact'])->name('contact');
    Route::get('/panels/new', [HomeController::class, 'addnewpanel'])->name('addnewpanel');
    Route::get('/userfinance', [HomeController::class, 'userfinance'])->name('userfinance');
    Route::get('/useraccount', [HomeController::class, 'useraccount'])->name('useraccount');
    Route::get('/panels/{name}', [HomeController::class, 'onedetail'])->name('onedetail');
    Route::post('/smm-panels/new', [HomeController::class, 'addpanel'])->name('addpanel');
});
